...
Date date=new Date();
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("insert into file(username,filename,filepath,status,status1,status2) values(?,?,?,?,?,?)");
        ...
        //    pst.setString(5, status);
            pst.executeUpdate();
            response.sendRedirect("up.jsp?msg=Success");
        } catch (Exception e) {
            out.println(e);
        }
