...
//String username = (String) request.getSession().getAttribute("username");
 ...
 String branch = (String) request.getSession().getAttribute("branch");
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("insert into upload1(username,filename,filepath,principal,branch,sdt,hdt) values(?,?,?,?,?,?,?)");
        ...
        //    pst.setString(5, status);
            pst.executeUpdate();
            response.sendRedirect("sc.jsp?msg=Success");
        } catch (Exception e) {
            out.println(e);
        }
